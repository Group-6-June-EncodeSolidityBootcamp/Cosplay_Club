...
// Interface of our contest contract
...
contract Contract {
    ...
    ContestContract internal contestContract;
    ...
    constructor(IWorldID _worldId, ContestContract _contestContract) {
        worldId = _worldId;
        contestContract = _contestContract;
    }
    ...
    function verifyAndExecute(
        ...
        contestContract.vote(tokenId, msg.sender);
    }
}
